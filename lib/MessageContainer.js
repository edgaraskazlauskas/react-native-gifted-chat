...
export default class MessageContainer extends React.PureComponent {
    constructor() {
        ...
        this.renderHeaderWrapper = () => (<View style={[styles.headerWrapper, this.props.headerWrapperStyle]}>{this.renderLoadEarlier()}</View>);
        this.onLayoutList = () => {
            if (!this.props.inverted &&
                !!this.props.messages &&
                ...
                const scrollDelay = this.props.layoutListScrollToBottomDelay ||
    ...
    render() {
        ...
        {this.state.showScrollBottom && this.props.scrollToBottom
            ...
            : null}
        <FlatList ref={this.props.forwardRef} extraData={[this.props.extraData, this.props.isTyping]} keyExtractor={this.keyExtractor} enableEmptySections automaticallyAdjustContentInsets={false} inverted={inverted} data={this.props.messages} style={styles.listStyle} contentContainerStyle={this.props.alignTop
            ? styles.contentContainerStyleAlignTop
            : styles.contentContainerStyle} renderItem={this.renderRow} {...this.props.invertibleScrollViewProps} ListEmptyComponent={this.renderChatEmpty} ListFooterComponent={inverted ? this.renderHeaderWrapper : this.renderFooter} ListHeaderComponent={inverted ? this.renderFooter : this.renderHeaderWrapper} onScroll={this.handleOnScroll} scrollEventThrottle={100} onLayout={this.onLayoutList} {...this.props.listViewProps}/>
      </View>);
    }
}
