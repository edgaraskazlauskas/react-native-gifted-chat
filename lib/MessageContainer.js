    ...
    constructor() {
        ...
        this.onLayoutList = () => {
            if (!this.props.inverted &&
                ...
                setTimeout(() => this.scrollToBottom && this.scrollToBottom(false), scrollDelay);
            }
        };
